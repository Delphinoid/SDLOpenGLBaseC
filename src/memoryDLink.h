...
#define memDLinkBlockGetFlags(block)      *((uintptr_t *)(block + MEMORY_DLINK_FLAG_OFFSET_FROM_BLOCK))
#define memDLinkBlockGetNext(block)       *((byte_t **)(block + MEMORY_DLINK_NEXT_OFFSET_FROM_BLOCK))
#define memDLinkBlockGetNextPointer(block) ((byte_t **)(block + MEMORY_DLINK_NEXT_OFFSET_FROM_BLOCK))
#define memDLinkBlockGetPrev(block)       *((byte_t **)(block + MEMORY_DLINK_PREV_OFFSET_FROM_BLOCK))
#define memDLinkBlockGetPrevPointer(block) ((byte_t **)(block + MEMORY_DLINK_PREV_OFFSET_FROM_BLOCK))
#define memDLinkBlockGetNextFree(block)   *((byte_t **)(block + MEMORY_DLINK_DATA_OFFSET_FROM_BLOCK))
#define memDLinkBlockGetData(block)        ((byte_t *)(block + MEMORY_DLINK_DATA_OFFSET_FROM_BLOCK))

#define memDLinkDataGetFlags(data)      *((uintptr_t *)(data + MEMORY_DLINK_FLAG_OFFSET_FROM_DATA))
#define memDLinkDataGetNext(data)       *((byte_t **)(data + MEMORY_DLINK_NEXT_OFFSET_FROM_DATA))
#define memDLinkDataGetNextPointer(data) ((byte_t **)(data + MEMORY_DLINK_NEXT_OFFSET_FROM_DATA))
#define memDLinkDataGetPrev(data)       *((byte_t **)(data + MEMORY_DLINK_PREV_OFFSET_FROM_DATA))
#define memDLinkDataGetPrevPointer(data) ((byte_t **)(data + MEMORY_DLINK_PREV_OFFSET_FROM_DATA))
...
#define memDLinkStart(array)        array->start
