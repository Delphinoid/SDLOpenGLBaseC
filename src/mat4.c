...
mat4 mat4MMultM(mat4 *m1, mat4 *m2){
	...
	r.m[0][0] = m2->m[0][0]*m1->m[0][0] + m2->m[0][1]*m1->m[1][0] + m2->m[0][2]*m1->m[2][0] + m2->m[0][3]*m1->m[3][0];
	r.m[0][1] = m2->m[0][0]*m1->m[0][1] + m2->m[0][1]*m1->m[1][1] + m2->m[0][2]*m1->m[2][1] + m2->m[0][3]*m1->m[3][1];
	r.m[0][2] = m2->m[0][0]*m1->m[0][2] + m2->m[0][1]*m1->m[1][2] + m2->m[0][2]*m1->m[2][2] + m2->m[0][3]*m1->m[3][2];
	r.m[0][3] = m2->m[0][0]*m1->m[0][3] + m2->m[0][1]*m1->m[1][3] + m2->m[0][2]*m1->m[2][3] + m2->m[0][3]*m1->m[3][3];

	r.m[1][0] = m2->m[1][0]*m1->m[0][0] + m2->m[1][1]*m1->m[1][0] + m2->m[1][2]*m1->m[2][0] + m2->m[1][3]*m1->m[3][0];
	r.m[1][1] = m2->m[1][0]*m1->m[0][1] + m2->m[1][1]*m1->m[1][1] + m2->m[1][2]*m1->m[2][1] + m2->m[1][3]*m1->m[3][1];
	r.m[1][2] = m2->m[1][0]*m1->m[0][2] + m2->m[1][1]*m1->m[1][2] + m2->m[1][2]*m1->m[2][2] + m2->m[1][3]*m1->m[3][2];
	r.m[1][3] = m2->m[1][0]*m1->m[0][3] + m2->m[1][1]*m1->m[1][3] + m2->m[1][2]*m1->m[2][3] + m2->m[1][3]*m1->m[3][3];

	r.m[2][0] = m2->m[2][0]*m1->m[0][0] + m2->m[2][1]*m1->m[1][0] + m2->m[2][2]*m1->m[2][0] + m2->m[2][3]*m1->m[3][0];
	r.m[2][1] = m2->m[2][0]*m1->m[0][1] + m2->m[2][1]*m1->m[1][1] + m2->m[2][2]*m1->m[2][1] + m2->m[2][3]*m1->m[3][1];
	r.m[2][2] = m2->m[2][0]*m1->m[0][2] + m2->m[2][1]*m1->m[1][2] + m2->m[2][2]*m1->m[2][2] + m2->m[2][3]*m1->m[3][2];
	r.m[2][3] = m2->m[2][0]*m1->m[0][3] + m2->m[2][1]*m1->m[1][3] + m2->m[2][2]*m1->m[2][3] + m2->m[2][3]*m1->m[3][3];

	r.m[3][0] = m2->m[3][0]*m1->m[0][0] + m2->m[3][1]*m1->m[1][0] + m2->m[3][2]*m1->m[2][0] + m2->m[3][3]*m1->m[3][0];
	r.m[3][1] = m2->m[3][0]*m1->m[0][1] + m2->m[3][1]*m1->m[1][1] + m2->m[3][2]*m1->m[2][1] + m2->m[3][3]*m1->m[3][1];
	r.m[3][2] = m2->m[3][0]*m1->m[0][2] + m2->m[3][1]*m1->m[1][2] + m2->m[3][2]*m1->m[2][2] + m2->m[3][3]*m1->m[3][2];
	r.m[3][3] = m2->m[3][0]*m1->m[0][3] + m2->m[3][1]*m1->m[1][3] + m2->m[3][2]*m1->m[2][3] + m2->m[3][3]*m1->m[3][3];
