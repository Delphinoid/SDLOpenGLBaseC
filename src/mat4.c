...
__HINT_INLINE__ void mat4MultMByM1(mat4 *const restrict m1, const mat4 m2){

	const mat4 m1_c = *m1;
	const mat4 r = {.m = {{m1_c.m[0][0]*m2.m[0][0] + m1_c.m[0][1]*m2.m[1][0] + m1_c.m[0][2]*m2.m[2][0] + m1_c.m[0][3]*m2.m[3][0],
	                       m1_c.m[0][0]*m2.m[0][1] + m1_c.m[0][1]*m2.m[1][1] + m1_c.m[0][2]*m2.m[2][1] + m1_c.m[0][3]*m2.m[3][1],
	                       m1_c.m[0][0]*m2.m[0][2] + m1_c.m[0][1]*m2.m[1][2] + m1_c.m[0][2]*m2.m[2][2] + m1_c.m[0][3]*m2.m[3][2],
	                       m1_c.m[0][0]*m2.m[0][3] + m1_c.m[0][1]*m2.m[1][3] + m1_c.m[0][2]*m2.m[2][3] + m1_c.m[0][3]*m2.m[3][3]},
	                      {m1_c.m[1][0]*m2.m[0][0] + m1_c.m[1][1]*m2.m[1][0] + m1_c.m[1][2]*m2.m[2][0] + m1_c.m[1][3]*m2.m[3][0],
	                       m1_c.m[1][0]*m2.m[0][1] + m1_c.m[1][1]*m2.m[1][1] + m1_c.m[1][2]*m2.m[2][1] + m1_c.m[1][3]*m2.m[3][1],
	                       m1_c.m[1][0]*m2.m[0][2] + m1_c.m[1][1]*m2.m[1][2] + m1_c.m[1][2]*m2.m[2][2] + m1_c.m[1][3]*m2.m[3][2],
	                       m1_c.m[1][0]*m2.m[0][3] + m1_c.m[1][1]*m2.m[1][3] + m1_c.m[1][2]*m2.m[2][3] + m1_c.m[1][3]*m2.m[3][3]},
	                      {m1_c.m[2][0]*m2.m[0][0] + m1_c.m[2][1]*m2.m[1][0] + m1_c.m[2][2]*m2.m[2][0] + m1_c.m[2][3]*m2.m[3][0],
	                       m1_c.m[2][0]*m2.m[0][1] + m1_c.m[2][1]*m2.m[1][1] + m1_c.m[2][2]*m2.m[2][1] + m1_c.m[2][3]*m2.m[3][1],
	                       m1_c.m[2][0]*m2.m[0][2] + m1_c.m[2][1]*m2.m[1][2] + m1_c.m[2][2]*m2.m[2][2] + m1_c.m[2][3]*m2.m[3][2],
	                       m1_c.m[2][0]*m2.m[0][3] + m1_c.m[2][1]*m2.m[1][3] + m1_c.m[2][2]*m2.m[2][3] + m1_c.m[2][3]*m2.m[3][3]},
	                      {m1_c.m[3][0]*m2.m[0][0] + m1_c.m[3][1]*m2.m[1][0] + m1_c.m[3][2]*m2.m[2][0] + m1_c.m[3][3]*m2.m[3][0],
	                       m1_c.m[3][0]*m2.m[0][1] + m1_c.m[3][1]*m2.m[1][1] + m1_c.m[3][2]*m2.m[2][1] + m1_c.m[3][3]*m2.m[3][1],
	                       m1_c.m[3][0]*m2.m[0][2] + m1_c.m[3][1]*m2.m[1][2] + m1_c.m[3][2]*m2.m[2][2] + m1_c.m[3][3]*m2.m[3][2],
	                       m1_c.m[3][0]*m2.m[0][3] + m1_c.m[3][1]*m2.m[1][3] + m1_c.m[3][2]*m2.m[2][3] + m1_c.m[3][3]*m2.m[3][3]}}};
	*m1 = r;

}
__HINT_INLINE__ void mat4MultMByM2(const mat4 m1, mat4 *const restrict m2){

	const mat4 m2_c = *m2;
	const mat4 r = {.m = {{m1.m[0][0]*m2_c.m[0][0] + m1.m[0][1]*m2_c.m[1][0] + m1.m[0][2]*m2_c.m[2][0] + m1.m[0][3]*m2_c.m[3][0],
	                       m1.m[0][0]*m2_c.m[0][1] + m1.m[0][1]*m2_c.m[1][1] + m1.m[0][2]*m2_c.m[2][1] + m1.m[0][3]*m2_c.m[3][1],
	                       m1.m[0][0]*m2_c.m[0][2] + m1.m[0][1]*m2_c.m[1][2] + m1.m[0][2]*m2_c.m[2][2] + m1.m[0][3]*m2_c.m[3][2],
	                       m1.m[0][0]*m2_c.m[0][3] + m1.m[0][1]*m2_c.m[1][3] + m1.m[0][2]*m2_c.m[2][3] + m1.m[0][3]*m2_c.m[3][3]},
	                      {m1.m[1][0]*m2_c.m[0][0] + m1.m[1][1]*m2_c.m[1][0] + m1.m[1][2]*m2_c.m[2][0] + m1.m[1][3]*m2_c.m[3][0],
	                       m1.m[1][0]*m2_c.m[0][1] + m1.m[1][1]*m2_c.m[1][1] + m1.m[1][2]*m2_c.m[2][1] + m1.m[1][3]*m2_c.m[3][1],
	                       m1.m[1][0]*m2_c.m[0][2] + m1.m[1][1]*m2_c.m[1][2] + m1.m[1][2]*m2_c.m[2][2] + m1.m[1][3]*m2_c.m[3][2],
	                       m1.m[1][0]*m2_c.m[0][3] + m1.m[1][1]*m2_c.m[1][3] + m1.m[1][2]*m2_c.m[2][3] + m1.m[1][3]*m2_c.m[3][3]},
	                      {m1.m[2][0]*m2_c.m[0][0] + m1.m[2][1]*m2_c.m[1][0] + m1.m[2][2]*m2_c.m[2][0] + m1.m[2][3]*m2_c.m[3][0],
	                       m1.m[2][0]*m2_c.m[0][1] + m1.m[2][1]*m2_c.m[1][1] + m1.m[2][2]*m2_c.m[2][1] + m1.m[2][3]*m2_c.m[3][1],
	                       m1.m[2][0]*m2_c.m[0][2] + m1.m[2][1]*m2_c.m[1][2] + m1.m[2][2]*m2_c.m[2][2] + m1.m[2][3]*m2_c.m[3][2],
	                       m1.m[2][0]*m2_c.m[0][3] + m1.m[2][1]*m2_c.m[1][3] + m1.m[2][2]*m2_c.m[2][3] + m1.m[2][3]*m2_c.m[3][3]},
	                      {m1.m[3][0]*m2_c.m[0][0] + m1.m[3][1]*m2_c.m[1][0] + m1.m[3][2]*m2_c.m[2][0] + m1.m[3][3]*m2_c.m[3][0],
	                       m1.m[3][0]*m2_c.m[0][1] + m1.m[3][1]*m2_c.m[1][1] + m1.m[3][2]*m2_c.m[2][1] + m1.m[3][3]*m2_c.m[3][1],
	                       m1.m[3][0]*m2_c.m[0][2] + m1.m[3][1]*m2_c.m[1][2] + m1.m[3][2]*m2_c.m[2][2] + m1.m[3][3]*m2_c.m[3][2],
	                       m1.m[3][0]*m2_c.m[0][3] + m1.m[3][1]*m2_c.m[1][3] + m1.m[3][2]*m2_c.m[2][3] + m1.m[3][3]*m2_c.m[3][3]}}};
	*m2 = r;

}
__HINT_INLINE__ void mat4MultMByMR(const mat4 m1, const mat4 m2, mat4 *const restrict r){

	const mat4 r_c = {.m = {{m1.m[0][0]*m2.m[0][0] + m1.m[0][1]*m2.m[1][0] + m1.m[0][2]*m2.m[2][0] + m1.m[0][3]*m2.m[3][0],
	                         m1.m[0][0]*m2.m[0][1] + m1.m[0][1]*m2.m[1][1] + m1.m[0][2]*m2.m[2][1] + m1.m[0][3]*m2.m[3][1],
	                         m1.m[0][0]*m2.m[0][2] + m1.m[0][1]*m2.m[1][2] + m1.m[0][2]*m2.m[2][2] + m1.m[0][3]*m2.m[3][2],
	                         m1.m[0][0]*m2.m[0][3] + m1.m[0][1]*m2.m[1][3] + m1.m[0][2]*m2.m[2][3] + m1.m[0][3]*m2.m[3][3]},
	                        {m1.m[1][0]*m2.m[0][0] + m1.m[1][1]*m2.m[1][0] + m1.m[1][2]*m2.m[2][0] + m1.m[1][3]*m2.m[3][0],
...
__HINT_INLINE__ vec4 mat4VMultMKet(const vec4 *const restrict v, const mat4 *const restrict m){
...
__HINT_INLINE__ void mat4MultVByMKet(vec4 *const restrict v, const mat4 *const restrict m){
	const vec4 r = {.x = v->x * m->m[0][0] + v->y * m->m[1][0] + v->z * m->m[2][0] + v->w * m->m[3][0],
	                .y = v->x * m->m[0][1] + v->y * m->m[1][1] + v->z * m->m[2][1] + v->w * m->m[3][1],
	                .z = v->x * m->m[0][2] + v->y * m->m[1][2] + v->z * m->m[2][2] + v->w * m->m[3][2],
	                .w = v->x * m->m[0][3] + v->y * m->m[1][3] + v->z * m->m[2][3] + v->w * m->m[3][3]};
...
__HINT_INLINE__ void mat4MultVByMKetR(const vec4 *const restrict v, const mat4 *const restrict m, vec4 *const restrict r){
...
__HINT_INLINE__ vec4 mat4MMultVBra(const mat4 *const restrict m, const vec4 *const restrict v){
...
__HINT_INLINE__ void mat4MultMByVBra(const mat4 *const restrict m, vec4 *const restrict v){
	const vec4 r = {.x = v->x * m->m[0][0] + v->y * m->m[0][1] + v->z * m->m[0][2] + v->w * m->m[0][3],
	                .y = v->x * m->m[1][0] + v->y * m->m[1][1] + v->z * m->m[1][2] + v->w * m->m[1][3],
	                .z = v->x * m->m[2][0] + v->y * m->m[2][1] + v->z * m->m[2][2] + v->w * m->m[2][3],
	                .w = v->x * m->m[3][0] + v->y * m->m[3][1] + v->z * m->m[3][2] + v->w * m->m[3][3]};
...
__HINT_INLINE__ void mat4MultMByVBraR(const mat4 *const restrict m, const vec4 *const restrict v, vec4 *const restrict r){
...
__HINT_INLINE__ mat4 mat4MAddM(const mat4 *const restrict m1, const mat4 *const restrict m2){
	mat4 r;
...
__HINT_INLINE__ void mat4AddMToM(mat4 *const restrict m1, const mat4 *const restrict m2){
...
__HINT_INLINE__ void mat4AddMToMR(const mat4 *const restrict m1, const mat4 *const restrict m2, mat4 *const restrict r){
	r->m[0][0] = m1->m[0][0] + m2->m[0][0]; r->m[0][1] = m1->m[0][1] + m2->m[0][1]; r->m[0][2] = m1->m[0][2] + m2->m[0][2]; r->m[0][3] = m1->m[0][3] + m2->m[0][3];
	r->m[1][0] = m1->m[1][0] + m2->m[1][0]; r->m[1][1] = m1->m[1][1] + m2->m[1][1]; r->m[1][2] = m1->m[1][2] + m2->m[1][2]; r->m[1][3] = m1->m[1][3] + m2->m[1][3];
	r->m[2][0] = m1->m[2][0] + m2->m[2][0]; r->m[2][1] = m1->m[2][1] + m2->m[2][1]; r->m[2][2] = m1->m[2][2] + m2->m[2][2]; r->m[2][3] = m1->m[2][3] + m2->m[2][3];
	r->m[3][0] = m1->m[3][0] + m2->m[3][0]; r->m[3][1] = m1->m[3][1] + m2->m[3][1]; r->m[3][2] = m1->m[3][2] + m2->m[3][2]; r->m[3][3] = m1->m[3][3] + m2->m[3][3];
...
__HINT_INLINE__ void mat4RotateToFace(mat4 *const restrict m, const vec3 *const restrict eye, const vec3 *const restrict target, const vec3 *const restrict up){
	...
	vec3SubVFromVR(target, eye, &zAxis);
	vec3NormalizeFast(&zAxis);
	vec3CrossR(&zAxis, up, &xAxis);
	vec3NormalizeFast(&xAxis);
	vec3CrossR(&xAxis, &zAxis, &yAxis);
