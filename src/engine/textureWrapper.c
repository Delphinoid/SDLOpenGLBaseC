...
__FORCE_INLINE__ void twiTick(twInstance *const __RESTRICT__ twi, const float dt_ms){
	animTick(&twi->animator, &twi->tw->animations[twi->currentAnim].animData, dt_ms*twi->timeMod);
}
