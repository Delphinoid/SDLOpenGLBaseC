...
return_t meshDefaultInit(){
	...
	vertices[4].u = 1.f; vertices[4].v = 1.f;
	...
	vertices[5].u = 1.f; vertices[5].v = 0.f;
	...
	vertices[6].u = 0.f; vertices[6].v = 1.f;
	...
	vertices[7].u = 0.f; vertices[7].v = 0.f;
	...
	vertices[8].u = 1.f; vertices[8].v = 0.f;
	...
	vertices[9].u = 0.f; vertices[9].v = 0.f;
	...
	vertices[10].u = 1.f; vertices[10].v = 1.f;
	...
	vertices[11].u = 0.f; vertices[11].v = 1.f;
	...
	vertices[12].u = 0.f; vertices[12].v = 0.f;
	...
	vertices[13].u = 0.f; vertices[13].v = 1.f;
	...
	vertices[14].u = 1.f; vertices[14].v = 0.f;
	...
	vertices[15].u = 1.f; vertices[15].v = 1.f;
	...
	vertices[16].u = 0.f; vertices[16].v = 1.f;
	...
	vertices[17].u = 1.f; vertices[17].v = 1.f;
	...
	vertices[18].u = 0.f; vertices[18].v = 0.f;
	...
	vertices[19].u = 1.f; vertices[19].v = 0.f;
	...
	vertices[20].u = 0.f; vertices[20].v = 1.f;
	...
	vertices[21].u = 1.f; vertices[21].v = 1.f;
	...
	vertices[22].u = 0.f; vertices[22].v = 0.f;
	...
	vertices[23].u = 1.f; vertices[23].v = 0.f;
