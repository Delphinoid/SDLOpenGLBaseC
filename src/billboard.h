...
#define BILLBOARD_TEXTURE_ANIMATE  0x0100  //
#define BILLBOARD_SKELETON_ANIMATE 0x0200  //
...
#ifndef BILLBOARD_ANIMATION_ANGLE_GRANULARITY
	// Defines how many separate frames should be per 360.
	#define BILLBOARD_ANIMATION_ANGLE_GRANULARITY 8
#endif
