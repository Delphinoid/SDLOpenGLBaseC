...
__HINT_INLINE__ void vec3NormalizeP(vec3 *const __RESTRICT__ v){
	vec3VMultSP(v, vec3MagnitudeInverseP(v));
}
__HINT_INLINE__ void vec3NormalizePR(const vec3 *const __RESTRICT__ v, vec3 *const __RESTRICT__ r){
