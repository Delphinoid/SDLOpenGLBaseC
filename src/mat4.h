...
void mat4MMultMPR(const mat4 *const restrict m1, const mat4 *const restrict m2, mat4 *const restrict r);
...
void mat4MAddMPR(const mat4 *const restrict m1, const mat4 *const restrict m2, mat4 *const restrict r);

float mat4Determinant(const mat4 m);
float mat4DeterminantP(const mat4 *const restrict m);

mat4 mat4Transpose(const mat4 m);
void mat4TransposeP(mat4 *const restrict m);
void mat4TransposePR(const mat4 *const restrict m, mat4 *const restrict r);

mat4 mat4Invert(const mat4 m);
return_t mat4InvertR(const mat4 m, mat4 *const restrict r);
return_t mat4InvertP(mat4 *const restrict m);
...
void mat4LookAtP(mat4 *const restrict m, const vec3 *const restrict eye, const vec3 *const restrict target, const vec3 *const restrict up);

mat4 mat4TranslationMatrix(const float x, const float y, const float z);
void mat4TranslationMatrixP(mat4 *const restrict r, const float x, const float y, const float z);
...
void mat4RotateP(mat4 *const restrict m, const quat *const restrict q);
void mat4RotatePR(const mat4 *const restrict m, const quat *const restrict q, mat4 *const restrict r);

mat4 mat4ScaleMatrix(const float x, const float y, const float z);
void mat4ScaleMatrixP(mat4 *const restrict m, const float x, const float y, const float z);
