...
__HINT_INLINE__ void mat3MultMByM1(mat3 *const restrict m1, const mat3 m2){

	const mat3 m1_c = *m1;
	const mat3 r = {.m = {{m1_c.m[0][0]*m2.m[0][0] + m1_c.m[0][1]*m2.m[1][0] + m1_c.m[0][2]*m2.m[2][0],
	                       m1_c.m[0][0]*m2.m[0][1] + m1_c.m[0][1]*m2.m[1][1] + m1_c.m[0][2]*m2.m[2][1],
	                       m1_c.m[0][0]*m2.m[0][2] + m1_c.m[0][1]*m2.m[1][2] + m1_c.m[0][2]*m2.m[2][2]},
	                      {m1_c.m[1][0]*m2.m[0][0] + m1_c.m[1][1]*m2.m[1][0] + m1_c.m[1][2]*m2.m[2][0],
	                       m1_c.m[1][0]*m2.m[0][1] + m1_c.m[1][1]*m2.m[1][1] + m1_c.m[1][2]*m2.m[2][1],
	                       m1_c.m[1][0]*m2.m[0][2] + m1_c.m[1][1]*m2.m[1][2] + m1_c.m[1][2]*m2.m[2][2]},
	                      {m1_c.m[2][0]*m2.m[0][0] + m1_c.m[2][1]*m2.m[1][0] + m1_c.m[2][2]*m2.m[2][0],
	                       m1_c.m[2][0]*m2.m[0][1] + m1_c.m[2][1]*m2.m[1][1] + m1_c.m[2][2]*m2.m[2][1],
	                       m1_c.m[2][0]*m2.m[0][2] + m1_c.m[2][1]*m2.m[1][2] + m1_c.m[2][2]*m2.m[2][2]}}};
	*m1 = r;

}
__HINT_INLINE__ void mat3MultMByM2(const mat3 m1, mat3 *const restrict m2){

	const mat3 m2_c = *m2;
	const mat3 r = {.m = {{m1.m[0][0]*m2_c.m[0][0] + m1.m[0][1]*m2_c.m[1][0] + m1.m[0][2]*m2_c.m[2][0],
	                       m1.m[0][0]*m2_c.m[0][1] + m1.m[0][1]*m2_c.m[1][1] + m1.m[0][2]*m2_c.m[2][1],
	                       m1.m[0][0]*m2_c.m[0][2] + m1.m[0][1]*m2_c.m[1][2] + m1.m[0][2]*m2_c.m[2][2]},
	                      {m1.m[1][0]*m2_c.m[0][0] + m1.m[1][1]*m2_c.m[1][0] + m1.m[1][2]*m2_c.m[2][0],
	                       m1.m[1][0]*m2_c.m[0][1] + m1.m[1][1]*m2_c.m[1][1] + m1.m[1][2]*m2_c.m[2][1],
	                       m1.m[1][0]*m2_c.m[0][2] + m1.m[1][1]*m2_c.m[1][2] + m1.m[1][2]*m2_c.m[2][2]},
	                      {m1.m[2][0]*m2_c.m[0][0] + m1.m[2][1]*m2_c.m[1][0] + m1.m[2][2]*m2_c.m[2][0],
	                       m1.m[2][0]*m2_c.m[0][1] + m1.m[2][1]*m2_c.m[1][1] + m1.m[2][2]*m2_c.m[2][1],
	                       m1.m[2][0]*m2_c.m[0][2] + m1.m[2][1]*m2_c.m[1][2] + m1.m[2][2]*m2_c.m[2][2]}}};
	*m2 = r;

}
__HINT_INLINE__ void mat3MultMByMR(const mat3 m1, const mat3 m2, mat3 *const restrict r){

	const mat3 r_c = {.m = {{m1.m[0][0]*m2.m[0][0] + m1.m[0][1]*m2.m[1][0] + m1.m[0][2]*m2.m[2][0],
	                         m1.m[0][0]*m2.m[0][1] + m1.m[0][1]*m2.m[1][1] + m1.m[0][2]*m2.m[2][1],
	                         m1.m[0][0]*m2.m[0][2] + m1.m[0][1]*m2.m[1][2] + m1.m[0][2]*m2.m[2][2]},
	                        {m1.m[1][0]*m2.m[0][0] + m1.m[1][1]*m2.m[1][0] + m1.m[1][2]*m2.m[2][0],
	                         m1.m[1][0]*m2.m[0][1] + m1.m[1][1]*m2.m[1][1] + m1.m[1][2]*m2.m[2][1],
